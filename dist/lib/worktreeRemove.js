...
import { findMainRepoRoot, getMintreeDir, getWorktreesDir, worktreeForBranch, listWorktrees, isDirty, removeWorktree, pruneWorktrees, pathExists, } from "./git.js";
 ...
 */
export function removeFailure(stderr) {
 ...
 */
function pruneMetadataFor(repoRoot, worktreePath) {
 ...
 */
function removeUnregistered(repoRoot, worktreePath, label, force) {
